...
*          Prof. Veríssimo                               *
*--------------------------------------------------------*
* Objetivo do Programa: Vetor Multidimensional.c         *
* Data - 05/03/2025                                      * 
* Autor: Júlio César                                     *
*--------------------------------------------------------*/
...
void estocar_produto(Produto estoque[RUAS][GONDOLAS], int rua, int gondola, char codigo[], int quantidade) {
...
void retirar_produto(Produto estoque[RUAS][GONDOLAS], char codigo[], int quantidade) {
...
int main() {
    Produto estoque[RUAS][GONDOLAS] = {0};  // Inicializa o estoque vazio
